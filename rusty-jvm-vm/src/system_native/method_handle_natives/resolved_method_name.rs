...
impl ResolvedMethodName {
    pub fn new_create_instance(vmholder: i32, vmtarget: i64) -> crate::error::Result<Self> {
    ...
    pub fn new_load_by_ref(resolved_method_name_ref: i32) -> crate::error::Result<Self> {
    ...
    pub fn propagate_all(&self) -> crate::error::Result<()> {
        self.propagate_vmholder()?;
        self.propagate_vmtarget()?;
        Ok(())
    }

    fn propagate_vmholder(&self) -> crate::error::Result<()> {
    ...
    fn propagate_vmtarget(&self) -> crate::error::Result<()> {
        with_heap_write_lock(|heap| {
            heap.set_object_field_value(
                self.resolved_method_name_ref,
                RESOLVED_METHOD_NAME,
...
fn load_vmholder(resolved_method_name_ref: i32) -> crate::error::Result<i32> {
...
fn load_vmtarget(resolved_method_name_ref: i32) -> crate::error::Result<i64> {
