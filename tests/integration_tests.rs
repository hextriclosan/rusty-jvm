...
#[test]
fn should_throw_for_null_jni_is_assignable_from() {
    let lib_dir_path = format!("-Djava.library.path={}", env!("JNI_TEST_LIB_PATH"));
    utils::assert_with_all_args(
        &[&lib_dir_path],
        "samples.javacore.loadlibrary.classops.JniIsAssignableNullDemo",
        &[],
        "valid=true\nnull sub caught\nnull sup caught\n",
        r#"WARNING: A restricted method in java.lang.System has been called
WARNING: java.lang.System::loadLibrary has been called by samples.javacore.loadlibrary.classops.JniIsAssignableNullDemo in an unnamed module
WARNING: Use --enable-native-access=ALL-UNNAMED to avoid a warning for callers in this module
WARNING: Restricted methods will be blocked in a future release unless native access is enabled
