...
public class GetDeclaredConstructorExample {
    public static void main(String[] args) throws Exception {
        ...
        Constructor<Person> ctor3 = Person.class.getDeclaredConstructor(String.class, int.class);
        ...
        Constructor<Person> ctor5 = Person.class.getDeclaredConstructor(String.class, int.class, String[].class);
