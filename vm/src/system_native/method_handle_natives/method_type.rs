...
use crate::system_native::method_handle_natives::common::decorate;
use getset::Getters;
...
impl MethodType {
    pub fn new(type_obj_ref: i32) -> crate::error::Result<Self> {
...
fn generate_parameters(ptype_class_refs: i32) -> crate::error::Result<String> {
...
fn generate_return_type(rtype_class_ref: i32) -> crate::error::Result<String> {
