...
public class NopGenerator {
    ...
    public static void main(String[] args) throws IOException {
        ...
        MethodVisitor mv = cw.visitMethod(Opcodes.ACC_PRIVATE | Opcodes.ACC_STATIC, "nopExample", "()I", null, null);
        mv.visitCode();
        ...
        mv.visitMethodInsn(Opcodes.INVOKESTATIC, FULL_NAME, "nopExample", "()I", false);
