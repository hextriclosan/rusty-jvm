...
pub(crate) fn set_pending_negative_array_size_exception(length: i32) -> Result<()> {
    set_pending_exception_with_message("java/lang/NegativeArraySizeException", &length.to_string())
}
