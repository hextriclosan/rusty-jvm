...
builtin_natives! {
    ...
    "java/io/UnixFileSystem": instance fn setReadOnly0(file: file) -> boolean => sn::file_system::set_read_only0;
    }
    ...
    "java/io/WinNTFileSystem": instance fn setReadOnly0(file: file) -> boolean => sn::file_system::set_read_only0;
    }
