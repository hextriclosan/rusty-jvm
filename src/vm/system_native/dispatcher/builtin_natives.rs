...
builtin_natives! {
    ...
    "java/io/RandomAccessFile": instance fn write0(byte: int) -> void => sn::random_access_file::write0;
    "java/io/RandomAccessFile": instance fn read0() -> int => sn::random_access_file::read0;
