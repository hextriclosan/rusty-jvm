...
builtin_natives! {
    ...
    "java/io/UnixFileSystem": instance fn rename0(from: file, to: file) -> boolean => sn::file_system::rename0;
    ...
    "java/io/WinNTFileSystem": instance fn rename0(from: file, to: file) -> boolean => sn::file_system::rename0;
